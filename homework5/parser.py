...
from Exceptions import InvalidArgvException
...
if len(sys.argv) == 2:
    if sys.argv[1] == '--json':
        ...
        top_users_by_count_of_requests_ended_server_error = \
            parser.top_five_users_by_count_of_requests_ended_server_error()
        ...
        raise InvalidArgvException(f"Expected --json argument, but a {sys.argv[1]} argument was obtained. Try again!")
